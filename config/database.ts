  ...
  const connections = {
    ...
    postgres: {
      ...
      pool: {
				...
				max: env.int('DATABASE_POOL_MAX', 90),
				...
				idleTimeoutMillis: env.int('DATABASE_IDLE_TIMEOUT_MILLIS', 10000),
				reapIntervalMillis: env.int('DATABASE_IDLE_TIMEOUT_MILLIS', 1000),
				createRetryIntervalMillis: env.int('DATABASE_CREATE_RETRY_INTERVAL_MILLIS', 200),
				propagateCreateError: env.int('DATABASE_PROPAGATE_CREATE_ERROR', true)
			},
    },
    sqlite: {
      connection: {
