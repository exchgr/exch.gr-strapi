...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    author: Attribute.String &
      ...
      Attribute.DefaultTo<'elle mundy'>;
    ...
    og_type: Attribute.Enumeration<['article', 'music.song', 'music.album']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOneOffOneOff extends Schema.CollectionType {
...
export interface ApiRedirectRedirect extends Schema.CollectionType {
  ...
  attributes: {
    ...
    httpCode: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<301>;
    publishedAt: Attribute.DateTime;
